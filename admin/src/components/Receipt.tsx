...
export type ReceiptLine = {
  ...
  unitPrice: number;
  lineTotal: number;
  /* ★ ส่วนลดของบรรทัดนี้ ★ ไม่มีตัวนี้แล้วกระดาษจะขัดแย้งกับตัวเอง: หัวบรรทัดเขียน
     "2 x ฿30" แต่ยอดขวามือเป็น ฿53 ลูกค้าบวกเลขตามแล้วไม่ตรง ซึ่งอ่านได้อย่างเดียวว่า
     ร้านคิดเงินผิด ทั้งที่ลดให้จริง ๆ · ยอด "ส่วนลด" ท้ายบิลเป็นส่วนลดทั้งใบเท่านั้น
     ส่วนลดรายชิ้นไม่เคยโผล่ตรงไหนบนกระดาษเลย */
  lineDiscount?: number;
  ...
  return (
    <>
      ...
      <div
        ...
        /* ★ ที่ว่างท้ายบิลพอประมาณ ★ บรรทัดสุดท้ายที่ชิดขอบกล่องพอดีคือต้นเหตุที่
           "สินค้าซื้อแล้วไม่รับคืน" หายไปตอนถ่ายเป็นรูป (เจ้าของเจอกับกระดาษจริง
           15 ก.ย. 2026) — ต้องมีที่ว่างให้การปัดเศษกินแทนตัวหนังสือ
           แต่เผื่อไว้สองบรรทัดเต็มก็เยอะเกินไป (เจ้าของแจ้งวันเดียวกันว่าขอบล่างเหลือเยอะ)
           สามในสี่ของบรรทัดพอกันพลาดแล้ว เพราะฝั่งตัวกลางยังเว้นขาวท้ายรูปให้อีกชั้น */
        className="font-mono text-black leading-snug pt-1 pb-[0.75em] [overflow-wrap:anywhere]">
