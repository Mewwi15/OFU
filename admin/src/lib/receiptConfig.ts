...
export type ReceiptConfig = {
  ...
  agentPort: number;
  /**
   * ขนาดตัวอักษรบนบิล (px) — ทุกบรรทัดวัดเป็นสัดส่วนของค่านี้
   *
   * ★ เล็กลง = ประหยัดกระดาษ ★ เจ้าของสั่งลดลงมา 15 ก.ย. 2026 หลังเห็นบิลจริง
   * บิลสั้นลงตรง ๆ ตามขนาดตัวอักษร ยิ่งขายวันละหลายร้อยบิลยิ่งเห็นผล
   * แต่เล็กเกินไปลูกค้าอ่านไม่ออกและกระดาษความร้อนจะเลอะจนตัวติดกัน — ปรับเองได้
   * ในหน้าตั้งค่าแล้วกดพิมพ์ทดสอบดู เร็วกว่าเดาจากส่วนกลาง
   */
  fontPx: number;
};
...
export const DEFAULT_CONFIG: ReceiptConfig = {
  ...
  autoPrint: false,
  agentPort: 9110,
  /* 10 แทนของเดิม 11 — เล็กลงหนึ่งขั้นตามที่เจ้าของสั่ง ยังอ่านสบายบนกระดาษ 48 มม. */
  fontPx: 10,
};
