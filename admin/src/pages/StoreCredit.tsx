...
export function StoreCredit() {
  ...
  return (
    <>
      ...
      {customer && (
        <>
          <Card className="mb-4" styles={{ body: { display: 'flex', alignItems: 'center', gap: 24, flexWrap: 'wrap' } }}>
            ...
            <Statistic title="เครดิตคงเหลือ" value={customer.balance} prefix="฿" valueStyle={{ color: '#C5410F', fontWeight: 700 }} />
