  ...
  return (
    <Card title="รหัสเข้าหลังร้าน" size="small">
      ...
      {/* เดิมยัดกฎสามข้อไว้บรรทัดเดียวคั่นด้วยจุด เจ้าของอ่านแล้วถามว่า "คือไร"
          ตอนตั้งรหัสต้องรู้แค่ว่าใส่อะไรได้ ส่วนการล็อกเมื่อเดารหัสไปบอกตอนที่มัน
          เกิดขึ้นจริงบนด่านเอา ไม่ใช่มากองรวมกันตรงนี้ */}
      ...
      {testOpen && shop && (
        <Modal
          ...
          <Alert
            ...
            /* ★ "ค่าเริ่มต้น" ของ Chrome คือย่อให้พอดีพื้นที่พิมพ์ ★ บิลเลยออกมาเล็กกว่า
               ที่ออกแบบไว้และลอยไปกลางม้วน (เจ้าของเจอ 5 ก.ย. 2026 "ตัวอักษรมันเล็ก")
               ต้องกำหนดเอง 100% ขนาดที่ตั้งเป็นมิลลิเมตรถึงจะออกมาเท่าจริง */
            message="ในหน้าพิมพ์ ตั้ง ระยะขอบ = ไม่มี · ปรับขนาด = กำหนดเอง 100% (อย่าใช้ค่าเริ่มต้น มันจะย่อบิลให้เล็กลง)"
          />
