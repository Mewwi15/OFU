-- 0021_drop_shift_requirement.sql
-- Owner found เปิดกะ/ปิดกะ (cash shifts) confusing → removed from the flow.
-- create_pos_sale no longer requires an open shift (shift_id is left null).
-- pos_shifts / open_shift / close_shift remain in place but unused.
