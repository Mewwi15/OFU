...
Deno.serve(async (req) => {
  ...
  /* ★ มีชื่อผู้ส่งอยู่ในเนื้อความด้วย ★ ผู้ให้บริการตรวจตอนอนุมัติ Sender ID ว่าชื่อผู้ส่ง
     สอดคล้องกับเนื้อความและเว็บไซต์ที่อ้างอิงไหม (เงื่อนไขข้อ 4 ของ SMS KUB) — ใส่ทั้ง
     ชื่อไทยที่ลูกค้ารู้จักและตัวอักษรที่จะขึ้นเป็นชื่อผู้ส่งจริง คนอ่านจะได้จับคู่กันถูกด้วย
     ว่า SMS จาก "OFU" คือร้านอู้ฟู่ · 65 ตัวอักษร ยังอยู่ใน 1 ข้อความ (เพดาน 70) */
  const message = `รหัส OTP ร้านอู้ฟู่ OFU คือ ${otp} (ใช้ได้ 5 นาที) ห้ามบอกผู้อื่น`;
