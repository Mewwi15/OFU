...
export const MOCK_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    kind: 'order',
    icon: 'bicycle',
    title: 'ออเดอร์กำลังไปหาคุณ',
    body: 'พีรพลรับสินค้าจากร้านอู้ฟู่แล้ว กำลังเดินทางไปส่ง',
    time: '5 นาที',
    unread: true,
  },
  {
    ...
    kind: 'promo',
    icon: 'pricetag',
    title: 'ลด 20% เฉพาะวันนี้',
    body: 'รับส่วนลดผักสดคัดพิเศษ วันนี้วันเดียวเท่านั้น',
    time: '1 ชม.',
    unread: true,
  },
  {
    ...
    kind: 'order',
    icon: 'ticket',
    title: 'ได้รับคูปองส่วนลด',
    body: 'คุณได้คูปอง ฿5 จากออเดอร์ล่าสุด ใช้ตอนชำระเงินได้เลย',
    time: '2 ชม.',
    unread: false,
  },
  {
    ...
    title: 'จัดส่งสำเร็จ',
    body: 'ทานให้อร่อยนะ อย่าลืมให้คะแนนร้านอู้ฟู่ด้วย',
    time: '4 ชม.',
    unread: false,
  },
  {
    ...
    kind: 'promo',
    icon: 'flame',
    title: 'กำลังมาแรงใกล้คุณ',
    body: 'ร้านอู้ฟู่มีคนสั่งเยอะสัปดาห์นี้ กว่า 100 ออเดอร์',
    time: '8 ชม.',
    unread: false,
  },
];
